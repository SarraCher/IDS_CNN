...
# bool_arr = np.random.choice([True, False],size=135)
...
filepath = './models/Binary/ToN-IoTwindows7/cnn_multi.json'
weightspath = './weights/Binary/ToN-IoTwindows7/cnn_multi.h5'
