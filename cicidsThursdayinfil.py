...
thursday_infiltration=['Infiltration','BENIGN']
...
# importing dataset
data = pd.read_csv('CICIDS2017_ThursdayInf.csv',header=None, names=col_names)
#print dataset
data
...
multi_data = numeric_multi.join(multi_data[['intrusion','Infiltration','BENIGN']])
...
# info_gain_vector = calculate_information_gain(multi_data, 'intrusion', exclude_columns=['Infiltration','BENIGN'])
...
# # Applying the function to the bin_data and excluding 'normal' and 'abnormal' attributes
# correlation_vector = calculate_pearson_correlation(multi_data, 'intrusion', exclude_columns=['Infiltration','BENIGN'])
...
#         Y = multi_data[['Infiltration','BENIGN']] # target attributes
...
filepath = './models/Multiclass/CICIDS2017/Thursday_Inf/cnn_multi.json'
weightspath = './weights/Multiclass/CICIDS2017/Thursday_Inf/cnn_multi.h5' 
...
accuracyCalcul(matrix, thursday_infiltration)
