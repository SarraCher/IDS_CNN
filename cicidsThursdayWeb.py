# -*- coding: utf-8 -*-
"""
Created on Sun Jun 19 11:21:05 2022
...
thursday_web=['Web Attack � Brute Force','Web Attack � XSS','Web Attack � Sql Injection','BENIGN']
...
# importing dataset
data = pd.read_csv('CICIDS2017_ThursdayWeb.csv',header=None, names=col_names)
#print dataset
data
...
multi_data = numeric_multi.join(multi_data[['intrusion','Web Attack � Brute Force','Web Attack � XSS','Web Attack � Sql Injection','BENIGN']])
...
# info_gain_vector = calculate_information_gain(multi_data, 'intrusion', exclude_columns=['Web Attack � Brute Force','Web Attack � XSS','Web Attack � Sql Injection','BENIGN'])
...
# # Applying the function to the bin_data and excluding 'normal' and 'abnormal' attributes
# correlation_vector = calculate_pearson_correlation(multi_data, 'intrusion', exclude_columns=['Web Attack � Brute Force','Web Attack � XSS','Web Attack � Sql Injection','BENIGN'])
...
# bool_arr = np.random.choice([True, False],size=83)
...
#         if(dSelect==0):
#             randomRemoval(solution,6)
#         else:
#             if (dSelect==1):
                
#                 shuffleRemoval(solution,6)
#             else:
#                 wrostRemoval(solution,score_vector,78)
                
#         if rSelect==0:
#             randomInsertion(solution,6)
#         else:
...
#         Y = multi_data[['Web Attack � Brute Force','Web Attack � XSS','Web Attack � Sql Injection','BENIGN']] # target attributes
...
bestV=[True, True, False, False, False, False, True, True, True, True, True, True, True, True, False, False, False, False, True, False, True, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, True, True, False, False, False, True, False, False, False, True, False, True, False, False, False, True, True, True, False, False, False, False, False, False, False, False, False, False, False, False, False, False, True, False, False, False, False, False, False, False, False, False,False, False, False, False]
...
filepath = './models/Multiclass/CICIDS2017/Thursday_Web/cnn_multi.json'
weightspath = './weights/Multiclass/CICIDS2017/Thursday_Web/cnn_multi.h5' 
...
accuracyCalcul(matrix, thursday_web)