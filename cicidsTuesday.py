# -*- coding: utf-8 -*-
"""
Created on Sun Jun 19 11:48:24 2022
...
def accuracyCalcul(matri,classes):
    ...
    for i in range(0,taille):
      ...
      #  print(classes[i]," faux alerte is ",FauxAlerte)
        print("***********************************")
tuesday=['FTP-Patator','SSH-Patator','BENIGN']
...
# importing dataset
data = pd.read_csv('CICIDS2017_Tuesday.csv',header=None, names=col_names)
#print dataset
data
...
multi_data = numeric_multi.join(multi_data[['intrusion','FTP-Patator','SSH-Patator','BENIGN']])
...
# info_gain_vector = calculate_information_gain(multi_data, 'intrusion', exclude_columns=['FTP-Patator','SSH-Patator','BENIGN'])
...
# # Applying the function to the bin_data and excluding 'normal' and 'abnormal' attributes
# correlation_vector = calculate_pearson_correlation(multi_data, 'intrusion', exclude_columns=['FTP-Patator','SSH-Patator','BENIGN'])
...
# bool_arr = np.random.choice([True, False],size=82)
...
#         Y = multi_data[['FTP-Patator','SSH-Patator','BENIGN']] # target attributes
...
bestV=[True, True, False, False, False, False, True, True, True, True, True, True, True, True, False, False, False, False, True, False, True, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, True, True, False, False, False, True, False, False, False, True, False, True, False, False, False, True, True, True, False, False, False, False, False, False, False, False, False, False, False, False, False, False, True, False, False, False, False, False, False, False, False, False,False, False, False]
...
filepath = './models/Multiclass/CICIDS2017/Tuesday/cnn_multi.json'
weightspath = './weights/Multiclass/CICIDS2017/Tuesday/cnn_multi.h5' 
