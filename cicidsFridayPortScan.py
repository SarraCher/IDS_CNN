# -*- coding: utf-8 -*-
"""
Created on Wed Jun 15 11:38:27 2022
...
friday_portscan=['PortScan','BENIGN']
...
# importing dataset
data = pd.read_csv('CICIDS2017_FridayPortscan.csv',header=None, names=col_names)
#print dataset
data
...
multi_data = numeric_multi.join(multi_data[['intrusion','PortScan','BENIGN']])
...
# info_gain_vector = calculate_information_gain(multi_data, 'intrusion', exclude_columns=['PortScan','BENIGN'])
...
# # Applying the function to the bin_data and excluding 'normal' and 'abnormal' attributes
# correlation_vector = calculate_pearson_correlation(multi_data, 'intrusion', exclude_columns=['PortScan','BENIGN'])
...
#         Y = multi_data[['PortScan','BENIGN']] # target attributes
...
filepath = './models/Multiclass/CICIDS2017/Friday_Portscan/cnn_multi.json'
weightspath = './weights/Multiclass/CICIDS2017/Friday_Portscan/cnn_multi.h5'
...
print(matrix)
accuracyCalcul(matrix, friday_portscan)
