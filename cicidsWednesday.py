...
wednesday=['DoS slowloris','DoS Slowhttptest','DoS Hulk','DoS GoldenEye','Heartbleed','BENIGN']
...
multi_data = numeric_multi.join(multi_data[['intrusion','DoS slowloris','DoS Slowhttptest','DoS Hulk','DoS GoldenEye','Heartbleed','BENIGN']])
...
# info_gain_vector = calculate_information_gain(multi_data, 'intrusion', exclude_columns=['DoS slowloris','DoS Slowhttptest','DoS Hulk','DoS GoldenEye','Heartbleed','BENIGN'])
...
# # Applying the function to the bin_data and excluding 'normal' and 'abnormal' attributes
# correlation_vector = calculate_pearson_correlation(multi_data, 'intrusion', exclude_columns=['DoS slowloris','DoS Slowhttptest','DoS Hulk','DoS GoldenEye','Heartbleed','BENIGN'])
...
# bool_arr = np.random.choice([True, False],size=85)
...
#         if(dSelect==0):
#             randomRemoval(solution,7)
#         else:
#             if (dSelect==1):
                
#                 shuffleRemoval(solution,7)
#             else:
#                 wrostRemoval(solution,score_vector,78)
                
#         if rSelect==0:
#             randomInsertion(solution,7)
#         else:
...
#         Y = multi_data[['DoS slowloris','DoS Slowhttptest','DoS Hulk','DoS GoldenEye','Heartbleed','BENIGN']] # target attributes
...
bestV=[True, True, False, False, False, False, True, True, True, True, True, True, True, True, False, False, False, False, True, False, True, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, True, True, False, False, False, True, False, False, False, True, False, True, False, False, False, True, True, True, False, False, False, False, False, False, False, False, False, False, False, False, False, False, True, False, False, False, False, False, False, False, False, False,False, False, False, False, False, False]
...
filepath = './models/Multiclass/CICIDS2017/Wednesday/cnn_multi.json'
weightspath = './weights/Multiclass/CICIDS2017/Wednesday/cnn_multi.h5'
...
accuracyCalcul(matrix,wednesday)