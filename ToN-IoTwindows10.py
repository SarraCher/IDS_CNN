...
multi_data = numeric_multi.join(multi_data[['intrusion','ddos','dos','injection','mitm','normal','password','scanning','xss']])
...
# info_gain_vector = calculate_information_gain(multi_data, 'intrusion', exclude_columns=['ddos','dos','injection','mitm','normal','password','scanning','xss'])
...
# # Applying the function to the bin_data and excluding 'normal' and 'abnormal' attributes
# correlation_vector = calculate_pearson_correlation(multi_data, 'intrusion', exclude_columns=['ddos','dos','injection','mitm','normal','password','scanning','xss'])
...
# bool_arr = np.random.choice([True, False],size=133)
...
#         Y = multi_data[['ddos','dos','injection','mitm','normal','password','scanning','xss']] # target attributes
...
bestV=[True, True, False, False, False, True, True, True, False, True, False, True, False, False, True, True, False, False, False, False, True, True, True, False, False, False, False, False, True, True, False, False, True, False, False, True, False, False, True, False, False, False, True, True, False, False, True, False, False, False, False, False, True, False, False, False, True, False, True, True, False, False, False, False, False, False, True, True, False, False, True, False, False, False, False, False, False, False, True, False, False, False, False, False, False, False, True, True, True, False, False, False, False, True, False, False, False, True, False, True, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, True, False, False, False, True, False, False, False, False, False, False,False, False, False, False, False, False, False]
...
filepath = './models/Multiclass/ToN-IoTwindows10/cnn_multi.json'
weightspath = './weights/Multiclass/ToN-IoTwindows10/cnn_multi.h5' 
