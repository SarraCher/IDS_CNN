...
#             else:
#                 aSelected=2
#         print("avant le choix")
#         ######hna ndir acceptation
#         if aSelected==0:
...
filepath = './models/Binary/CICIDS2017/Thursday_Inf/cnn_multi.json'
weightspath = './weights/Binary/CICIDS2017/Thursday_Inf/cnn_multi.h5'  
